...
export default class Display {
    ...
    */
    ...
    _rescale(factor) {
        ...
        const width = factor * vp.serverWidth;
        const height = factor * vp.serverHeight;
        
        const ratio = 640 / 480;
        
        // Fit to width first
        let nWidth = width;
        let nHeight = width / ratio;
        ...
        let wnWidth = nWidth + 'px';
        let wnHeight = nHeight + 'px';

        if ((this._target.style.width !== wnWidth) ||
            (this._target.style.height !== wnHeight)) {
            this._target.style.width = wnWidth;
            this._target.style.height = wnHeight;
        }
